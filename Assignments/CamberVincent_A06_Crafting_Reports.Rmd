...
```{r,echo=FALSE,warning=FALSE,fig.align='left',fig.height=3,fig.cap="2018 Monthly Ozone Levels"}
#Data filter for 2018 to create boxplot
epa_2018<-epa_data%>%filter(Year==2018)

ggplot(epa_2018,aes(x=factor(Month,labels=month.abb),y=Ozone))+
  geom_boxplot()+
  labs(x="Month",y="Concentration (µg/m³)",title="Montly Ozone Concentrations (2018)")
```

```{r,echo=FALSE,warning=FALSE,fig.align='left',fig.height=3,fig.cap="2019 Monthly Ozone Levels"}
#Data filter for 2019 to create boxplot
epa_2019<-epa_data%>%filter(Year==2019)

ggplot(epa_2019,aes(x=factor(Month,labels=month.abb),y=Ozone))+
  geom_boxplot()+
  labs(x="Month",y="Concentration (µg/m³)",title="Montly Ozone Concentrations (2019)")
```
